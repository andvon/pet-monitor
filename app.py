...
st.session_state.last_pee_diff = f'{round(((datetime.now() - st.session_state.pee_df.date[0]).total_seconds() / 3600),2)} Hours' if len(st.session_state.pee_df.index) > 0 else None
...
st.session_state.last_poo_diff = f'{round(((datetime.now() - st.session_state.poo_df.date[0]).total_seconds() / 3600),2)} Hours' if len(st.session_state.poo_df.index) > 0 else None
...
st.session_state.last_feeding_diff = f'{round(((datetime.now() - st.session_state.food_df.date[0]).total_seconds() / 3600),2)} Hours' if len(st.session_state.food_df.index) > 0 else None
...
st.session_state.last_watering_diff = f'{round(((datetime.now() - st.session_state.water_df.date[0]).total_seconds() / 3600),2)} Hours' if len(st.session_state.water_df.index) > 0 else None
...
st.session_state.last_insulin_diff = f'{round(((datetime.now() - st.session_state.insulin_df.date[0]).total_seconds() / 3600),2)} Hours' if len(st.session_state.insulin_df.index) > 0 else None
	...
	with st.container():
		...
		with col1:
			...
			if pee_button:
				...
				st.session_state.last_pee_diff = f'{round(((datetime.now() - st.session_state.last_pee).total_seconds() / 3600),2)} Hours'
		...
		with col2:
			...
			if poo_button:
				...
				st.session_state.last_poo_diff = f'{round(((datetime.now() - st.session_state.last_poo).total_seconds() / 3600),2)} Hours'
	...
	with st.container():
		...
		with col1:
			...
			if food_button:
				...
				st.session_state.last_feeding_diff = f'{round(((datetime.now() - st.session_state.last_feeding).total_seconds() / 3600),2)} Hours'
		...
		with col2:
			...
			if water_button:
				...
				st.session_state.last_watering_diff = f'{round(((datetime.now() - st.session_state.last_watering).total_seconds() / 3600),2)} Hours'
...
with insulin_tab:
	...
	if insulin_record:
		...
		st.session_state.last_insulin_diff = f'{round(((datetime.now() - st.session_state.last_insulin).total_seconds() / 3600),2)} Hours'
	st.write("--------------")
